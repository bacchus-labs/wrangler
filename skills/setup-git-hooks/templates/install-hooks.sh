#!/bin/bash
# install-hooks.sh - Install version-controlled git hooks from .wrangler/config/git-hooks/
# Generated by wrangler git-hooks framework (Pattern B)
#
# Usage:
#   ./scripts/install-hooks.sh
#
# This script creates symlinks from .git/hooks/ to .wrangler/config/git-hooks/
...
# Configuration
# =============================================================================
HOOKS_SOURCE_DIR=".wrangler/config/git-hooks"
...
for hook in "${HOOKS[@]}"; do
    ...
    if [ -f "$source" ]; then
        ...
        # From .git/hooks/ to .wrangler/config/git-hooks/, we need ../../.wrangler/config/git-hooks/
        ln -s "../../$source" "$target"
